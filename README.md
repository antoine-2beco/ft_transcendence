...
- Pour Transcendence :
	- En backend, utilisation de NestJS
	- En frontend, utilisation d'un framework qui repond a l'architecture Single Page App

# Notions importantes du sujet
- L'utilisation de librairie ou d'outil non officiellement autorise est autorise mais il ne peut pas regler un probleme entier ou une feature, seulement de petits problemes.
- Le projet doit etre lance via Docker via une seule commande.
- Le projet doit etre reflechi a l'avance, le design, le choix des modules, la strategie, certains modules peuvent etre en conflits ou dependance.

# Pre-transcendence Piscine
- [ ] Piscine de TypeScript, NestJs, SQL, HTML, CSS et le framework front
- [ ] Utiliser la methode Scrum et Agile puis faire un Kanban board et faire un brouillon de la structure du projet
- [ ] Ecrire les separations du projet, comment faire un maximum de communication en ammont pour l'eviter plus tard ?
- [x] Se renseigner sur le Design Thinking Method
...
- [Mythical Man Mouth](https://www.youtube.com/watch?v=vuScajG_FuI)
- [Design Thinking Method](https://ux-ui.fr/design-thinking-definition-exemple-methode/)